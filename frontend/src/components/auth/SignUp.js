...
function SignUp() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    axios
      .post("http://localhost:4451/api/users/register", data)
      .then((res) => {
        if (res.status === 200) {
          navigate("/sign-in");
        }
  ...
  return (
    <div className="py-[10%] h-[80%] min-h-screen bg-gray-100 text-gray-900 flex justify-center">
