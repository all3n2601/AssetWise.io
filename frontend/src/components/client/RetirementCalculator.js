...
function RetirementCalculator() {
  return (
    <>
          ...
          <ul class="space-y-2 font-medium">
            <li>
              ...
              >
                ...
                <span class="ms-3">Retirement Calculator</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Loan Calculator</span>
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Debt Management</span>
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">All Transactions</span>
              </a>
            </li>
      ...
      <section id="retirement" className="flex items-center justify-center h-screen bg-gray-100">
        <div className="relative flex flex-col text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
          ...
          <p className="block mt-1 font-sans text-base antialiased font-normal leading-relaxed text-gray-700">
            Calculate your retirement savings and expenses
          </p>
          <form className="max-w-screen-lg mt-8 mb-2 flex flex-col sm:flex-row gap-8">
            <div className="flex flex-col gap-6 mb-1 flex-grow">
      ...
      <section id="loan" className="flex items-center justify-center h-screen bg-gray-100">
        <div className="relative flex flex-col text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
          <h4 className="block font-sans text-3xl antialiased font-semibold leading-snug tracking-normal text-blue-gray-900">
            Loan Calculator
          </h4>
      ...
      <section id="debt" className="flex items-center justify-center h-screen bg-gray-100">
        <div className="relative flex flex-col text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
          <h4 className="block font-sans text-3xl antialiased font-semibold leading-snug tracking-normal text-blue-gray-900">
            Debt Calculator
          </h4>
